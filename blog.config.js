...
const BLOG = {
  ...
  // Hobby-safe default: six hours. The previous 60-second default made a
  // mostly static blog regenerate on ordinary crawler traffic thousands of
  // times per day. Override this when fresher Notion content is worth the cost.
  NEXT_REVALIDATE_SECOND:
    process.env.NEXT_PUBLIC_REVALIDATE_SECOND || 6 * 60 * 60,
